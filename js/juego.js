...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/auto_verde_abajo.png', 870, 430, 15, 30, 1),
  ...
  //NOTA: declaro los enemigos de esta manera para no perderme entre tantos parametros.
  enemigos: [
    new ZombieConductor(
      ...
      alto=30,
      velocidad=10,
      rangoMov={desdeX:0,hastaX:900,desdeY:0,hastaY:89},
      esVertical=false
    ),
    new ZombieConductor(
      ...
      alto=90,
      velocidad=5,
      rangoMov={desdeX:0,hastaX:900,desdeY:0,hastaY:500},
      esVertical=true
    ),
    new ZombieConductor(
      sprite='imagenes/tren_vertical.png',
      ...
      alto=90,
      velocidad=8,
      rangoMov={desdeY:0, hastaY:500},
      esVertical=true),
    new ZombieCaminante(
      sprtite='imagenes/zombie1.png',
      x=100,
      y=255,
      alto=10,
      ancho=10,
      velocidad=1,
      rangoMov={desdeX:60, hastaX:170, desdeY:200, hastaY:400}),
      new ZombieCaminante(
        sprite='imagenes/zombie2.png',
        x= 500,
        y= 250,
        ancho=10,
        alto=10,
        velocidad=1,
        rangoMov={desdeX:450, hastaX:580,desdeY:270,hastaY:290}
      ),
      new ZombieCaminante(
        sprite='imagenes/zombie3.png',
        x= 290,
        y= 50,
        ancho=10,
        alto=10,
        velocidad=1.5,
        rangoMov={desdeX:290, hastaX:550,desdeY:90,hastaY:130}
      ),
      new ZombieCaminante(
        sprite='imagenes/zombie4.png',
        x= 800,
        y= 280,
        ancho=10,
        alto=10,
        velocidad=0.8,
        rangoMov={desdeX:750, hastaX:880,desdeY:200,hastaY:300}
      )
  ]
}//Todos los enemigos cargados
